...
async function askGemini(question: string, context: unknown) {
  ...
  const prompt = [
    ...
    "مخاطب یکی از مدیران یا کارکنان استانداری سمنان است؛ نام، نقش و نمای جاری او در اطلاعات زمینه‌ای آمده است.",
    "پاسخ را متناسب با حوزه دسترسی و مسئولیت همان کاربر تنظیم کن و وارد اطلاعات نامرتبط با حوزه او نشو.",
