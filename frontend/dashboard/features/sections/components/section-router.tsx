...
import { CrisisPanel, DataGovernancePanel, ForecastPanel, BenchmarkPanel, NewsIntelligencePanel, PerformancePanel, ProcurementPanel, SectorIntelligencePanel, SpeechIntelligencePanel } from "./intelligence-panels";
...
export function SectionRouter({ section, data, onNavigate }: { section: CommandSectionId; data: CommandCenterData; onNavigate: (section: CommandSectionId) => void }) {
  switch (section) {
    ...
    case "benchmark": return <BenchmarkPanel data={data} />;
