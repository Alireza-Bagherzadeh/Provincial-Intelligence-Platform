...
const fallbackNews: CommandCenterData["newsArticles"] = [
  ...
  { id: "n3", title: "آگهی ثبت‌نام تکمیل ظرفیت آزمون استخدامی دستگاه‌های اجرایی", summary: "نمونه‌ای از اطلاعیه‌های خدماتی و استخدامی موجود در آرشیو سایت استانداری.", category: "اطلاعیه", kind: "notice", publishedAt: "2026-08-09", sourceUrl: "", sourceLabel: "آرشیو اسناد استانداری", sentimentScore: "0", importance: 88, county: null, isDemo: true },
...
const fallbackData: Omit<CommandCenterData, "endpoint" | "connectionMessage"> = {
  ...
  metrics: [
    ...
    { key: "progress", label: "میانگین پیشرفت واقعی", value: "۶۲٪", delta: "نمونه تحلیلی", status: "attention", isDemo: true },
  ...
  brief: [
    { kind: "crisis", title: "تنش آبی شرق استان بالاترین سیگنال تاب‌آوری را دارد.", detail: "Impact Score نمایشی ۸۸/۱۰۰؛ برای Production باید به آب، هواشناسی و پروژه‌های واقعی متصل شود.", actionLabel: "مرکز بحران", isDemo: true },
    { kind: "forecast", title: "Forecast تنش آبی در افق ۳۰ روز نزولی است.", detail: "سناریوی نمایشی ۵۸ → ۵۱ با بازه عدم‌قطعیت؛ عدد رسمی نیست.", actionLabel: "هشدار زودهنگام", isDemo: true },
    { kind: "sector", title: "ریسک آب و محیط‌زیست در بالاترین سطح توجه است.", detail: "در نسخه عملیاتی این هشدار باید از سری زمانی، سنجش از دور و داده شهرستانی تغذیه شود.", actionLabel: "هوشمندی بخشی", isDemo: true },
    { kind: "risk", title: "دو پروژه نمونه از برنامه عقب هستند.", detail: "انحراف برنامه و عملکرد به مرکز هشدار و خلاصه اجرایی متصل شده است.", actionLabel: "مرکز پروژه‌ها", isDemo: true }
  ],
  counties: demoCounties,
  projects: [
    { title: "آبرسانی پایدار شرق استان", status: "critical", plannedProgress: "58", actualProgress: "41", responsibleOrganization: "دستگاه نمونه آب و زیرساخت", isDemo: true, county: { code: "shahroud", name: "شاهرود" } },
    { title: "تکمیل محور ارتباطی شمال", status: "attention", plannedProgress: "76", actualProgress: "69", responsibleOrganization: "دستگاه نمونه راه و حمل‌ونقل", isDemo: true, county: { code: "semnan", name: "سمنان" } },
    { title: "توسعه زیرساخت صنعتی", status: "on_track", plannedProgress: "86", actualProgress: "84", responsibleOrganization: "دستگاه نمونه صنعت و سرمایه‌گذاری", isDemo: true, county: { code: "garmsar", name: "گرمسار" } },
    { title: "کاهش تنش آبی روستاهای هدف", status: "critical", plannedProgress: "62", actualProgress: "43", responsibleOrganization: "دستگاه نمونه آب و زیرساخت", isDemo: true, county: { code: "meyami", name: "میامی" } },
    { title: "ارتقای خدمات دیجیتال فرمانداری", status: "on_track", plannedProgress: "68", actualProgress: "72", responsibleOrganization: "دستگاه نمونه تحول دیجیتال", isDemo: true, county: { code: "sorkheh", name: "سرخه" } },
    { title: "بهبود مسیرهای روستایی", status: "attention", plannedProgress: "57", actualProgress: "48", responsibleOrganization: "دستگاه نمونه راه و حمل‌ونقل", isDemo: true, county: { code: "mahdishahr", name: "مهدی‌شهر" } }
  ],
  alerts: [
  ...
  organizations: [
    { name: "دستگاه نمونه آب و زیرساخت", code: "demo-infra", performanceScore: "71", isDemo: true },
    { name: "دستگاه نمونه صنعت و سرمایه‌گذاری", code: "demo-economy", performanceScore: "79", isDemo: true },
    { name: "دستگاه نمونه خدمات عمومی", code: "demo-services", performanceScore: "84", isDemo: true },
    { name: "دستگاه نمونه تحول دیجیتال", code: "demo-digital", performanceScore: "76", isDemo: true }
  ],
  decisions: [
    { title: "رفع مانع آبرسانی شرق استان", status: "overdue", dueDate: "2026-08-05", progress: "46", isDemo: true, owner: { name: "دستگاه نمونه آب و زیرساخت" }, county: { name: "شاهرود" } },
    { title: "تکمیل بسته فرصت‌های سرمایه‌گذاری", status: "open", dueDate: "2026-09-02", progress: "52", isDemo: true, owner: { name: "دستگاه نمونه صنعت و سرمایه‌گذاری" }, county: { name: "گرمسار" } }
  ],
  budgetRecords: [
  ...
  reports: [
    { title: "گزارش صبحگاهی استان", reportType: "morning_brief", periodLabel: "امروز", status: "ready", isDemo: true, organization: { name: "دستگاه نمونه خدمات عمومی" } },
    { title: "گزارش هوشمندی خبر و افکار عمومی", reportType: "news_intelligence", periodLabel: "۷ روز اخیر", status: "ready", isDemo: true, organization: { name: "دستگاه نمونه تحول دیجیتال" } }
  ],
  newsArticles: fallbackNews,
  sectorIndicators: fallbackSectors,
  procurementNotices: [
    { id: "p1", title: "تأمین تجهیزات پایش زیرساخت", status: "open", publishedAt: "2026-08-10", deadline: "2026-08-24", estimatedAmount: "21000000000", procurementMethod: "مناقصه عمومی", referenceCode: "DEMO-1405-01", organization: { name: "دستگاه نمونه آب و زیرساخت", code: "demo-infra" }, county: { name: "سمنان" }, isDemo: true },
    { id: "p2", title: "خدمات توسعه داشبورد داده", status: "evaluation", publishedAt: "2026-08-05", deadline: "2026-08-16", estimatedAmount: "8500000000", procurementMethod: "مناقصه عمومی", referenceCode: "DEMO-1405-02", organization: { name: "دستگاه نمونه تحول دیجیتال", code: "demo-digital" }, county: { name: "سمنان" }, isDemo: true },
    { id: "p3", title: "بهسازی دسترسی جاذبه‌های گردشگری", status: "planned", publishedAt: "2026-08-10", deadline: "2026-09-04", estimatedAmount: "14000000000", procurementMethod: "مناقصه عمومی", referenceCode: "DEMO-1405-03", organization: { name: "دستگاه نمونه میراث و گردشگری", code: "demo-tourism" }, county: { name: "شاهرود" }, isDemo: true }
  ],
  speechInsights: [
    { id: "sp1", speaker: "استاندار - نمونه تحلیلی", role: "مقام اجرایی استان", spokenAt: "2026-08-10", topic: "آب", summary: "تبدیل مسئله کمبود آب به برنامه قابل سنجش و شهرستان‌محور.", commitmentText: "گزارش هفتگی ریسک آب و پیشرفت اقدامات آماده شود.", commitmentStatus: "at_risk", county: { name: "سمنان" }, sourceUrl: "", isDemo: true },
    { id: "sp2", speaker: "استاندار - نمونه تحلیلی", role: "مقام اجرایی استان", spokenAt: "2026-08-02", topic: "سرمایه‌گذاری", summary: "تمرکز بر رفع موانع و کوتاه شدن زمان تبدیل فرصت به پروژه.", commitmentText: "بسته موانع سرمایه‌گذاری با مسئول و موعد مشخص پیگیری شود.", commitmentStatus: "in_progress", county: { name: "گرمسار" }, sourceUrl: "", isDemo: true }
  ],
  ...
  crisisSignals: [
    { id: "c1", title: "تنش آبی شرق استان", category: "آب", severity: "critical", status: "monitoring", occurredAt: "2026-08-10", impactScore: 88, summary: "سیگنال نمایشی ترکیبی از منابع آب، پروژه‌ها و درخواست‌ها.", sourceLabel: "Seed مرکز تاب‌آوری", county: { name: "شاهرود" }, isDemo: true },
    { id: "c2", title: "ریسک محدودیت انرژی صنایع", category: "انرژی", severity: "high", status: "monitoring", occurredAt: "2026-08-09", impactScore: 73, summary: "پایش اثر محدودیت انرژی بر صنعت و تولید.", sourceLabel: "Seed مرکز تاب‌آوری", county: { name: "گرمسار" }, isDemo: true },
    { id: "c3", title: "هشدار خشکسالی و فرونشست", category: "محیط‌زیست", severity: "high", status: "open", occurredAt: "2026-08-08", impactScore: 79, summary: "Placeholder برای اتصال سنجش از دور و داده‌های محیطی.", sourceLabel: "Seed مرکز تاب‌آوری", county: null, isDemo: true },
    { id: "c4", title: "اختلال خدمات عمومی نمونه", category: "خدمات", severity: "medium", status: "resolved", occurredAt: "2026-08-06", impactScore: 42, summary: "نمونه چرخه رخداد تا رفع.", sourceLabel: "Seed مرکز تاب‌آوری", county: { name: "سمنان" }, isDemo: true }
  ],
  forecastSignals: [
